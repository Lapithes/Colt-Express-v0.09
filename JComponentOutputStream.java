...
public class JComponentOutputStream extends OutputStream {
    ...
    public JComponentOutputStream(JLabel txtara, JComponentHandler jComponentHandler) {
        this(txtara, 1000, jComponentHandler);
    }

    public JComponentOutputStream(JLabel txtara, int maxlin, JComponentHandler handler) {
        if (maxlin < 1) {
